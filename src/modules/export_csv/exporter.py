...
def export(pairs):
    ...
    for pair in pairs:
        ...
        filters = ','.join(api_query['filters'])  # Separar métricas por coma
        ...
        data.append({'Natural Language Query': natural_language_query, 'Metrics': metrics, 'Dimensions': dimensions, 'Filters': filters, 'Date Ranges': date_ranges})
